...
smarterTrackChatInit({
  "ControlID": "stlivechat0",
  "RefreshUrl": "//support.iranhost.com:443/ChatLink.ashx?config=7&refresh=1",
  "RefreshTimeSeconds": 30,
  "Online": {
    "Url": "//support.iranhost.com:443/Main/Chat/frmClientChat.aspx?config=7",
    "Target": "",
    "Title": "Chat with us!",
