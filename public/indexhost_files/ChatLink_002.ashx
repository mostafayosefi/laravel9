...
smarterTrackChatInit({
  "ControlID": "stlivechat01",
  "RefreshUrl": "//support.iranhost.com:443/ChatLink.ashx?config=8&refresh=1",
  "RefreshTimeSeconds": 30,
  "Online": {
    "Url": "//support.iranhost.com:443/Main/Chat/frmClientChat.aspx?config=8",
    "Target": "",
    "Title": "Chat with us!",
    "ImageUrl": "https://iranhost.com/assets/images/sms.svg",
    "CssClass": null,
