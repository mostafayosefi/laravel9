...
<tr>
    ...
    <td>
        ...
        @include('admin.order.modal_operation', [ 'route' => route('admin.order.status' , [ 'order'=>$renew->order , 'status'=>'active' ]  ) , 'operat' => 'accept' ])
        @endif
        @if ($renew->status != 'inactive')
        @include('admin.order.modal_operation', [ 'route' => route('admin.order.status' , [ 'order'=>$renew->order , 'status'=>'inactive' ]  ) , 'operat' => 'cancel' ])
        @endif
    </td>
</tr>
@endif
