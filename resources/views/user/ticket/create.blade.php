@component('index.layouts.content',[
    ...
    'breadcrumb'=>[
            ['title'=>'ایجاد تیکت جدید','class' => 'active']
    ]])
                                    ...
                                    <div class="elementor-element elementor-element-c438a9c elementor-widget elementor-widget-rt-heading"
                                        ...
                                        <div class="elementor-widget-container">
                                            <div class="rt-heading-wrapper style-3 text-center">
                                                <H2 class="   rt-heading style-3">ایجاد تیکت جدید  </H2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="elementor-element elementor-element-412944a elementor-widget elementor-widget-rt-pricing-table"
                                        ...
                                        <form class="elementor-form" enctype="multipart/form-data" method="post"
                                            ...
                                            <div
                                                ...
                                                <label  class="{{ $errors->has('title') ? 'red' : '' }}"  > <span class="red" >*</span> موضوع تیکت</label>
                                        ...
                                        <div
                                            class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-50">
                                            <label  class="{{ $errors->has('text') ? 'red' : '' }}"  > <span class="red" >*</span> متن پیام</label>

                                            <textarea name="text" id="form-field-name"  class="elementor-field elementor-size-sm  elementor-field-textual"    rows="6" >{{old('text')}}</textarea>
...
{{-- @method('PUT') --}}
                                        ...
                                        <div  class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-50">
                                            ...
                                            <span>
                                                ...
                                                <span class="elementor-button-text">ثبت تیکت
                                                     </span>
                                            </span>
                                        </button>
                                        </div>
