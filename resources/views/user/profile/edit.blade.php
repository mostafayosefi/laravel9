@component('index.layouts.content', [
    ...
    'tabTitle' => 'ویرایش پروفایل من ',
    'breadcrumb' => [['title' => 'ویرایش پروفایل من ', 'class' => 'active']],
    ])
                                            ...
                                            <form class="elementor-form" enctype="multipart/form-data" method="post"
                                                ...
                                                <div class="elementor-form-fields-wrapper elementor-labels-above"
                                                    ...
                                                    <div
                                                        class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-40">
                                                        <label> تلفن </label>
                                                        <input size="1" type="text" name="tell" id="form-field-name"
                                                            class="elementor-field elementor-size-sm  elementor-field-textual"
                                                            placeholder="تلفن   " value="{{ $user->tell }}"
                                                            aria-required="true">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="elementor-form-fields-wrapper elementor-labels-above"
                                                    ...
                                                    <div
                                                        ...
                                                        <input size="1" type="text" name="username" id="form-field-name"
                                                            class="elementor-field elementor-size-sm  elementor-field-textual"
                                                            placeholder="نام کاربری"  required="required"
                                                            value="{{ $user->username }}" aria-required="true">
                                                    </div>
                                                    <div
                                                        class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required">
                                                    </div>
                                                ...
                                                <div class="elementor-form-fields-wrapper elementor-labels-above"
                                                    ...
                                                    <div
                                                        class="elementor-field-type-upload elementor-field-group elementor-column elementor-field-group-field_e7a3959 elementor-col-40">


                                        @include('index.layouts.elementor.avatar', [  'avatarimage' => $user->image  ])

                                                        <label for="form-field-field_e7a3959"
                                                            class="elementor-field-label">تصویرپروفایل</label>

                                                        <input type="file" name="image" id="form-field-field_e7a3959"
                                                            class="elementor-field elementor-size-sm  elementor-upload-field"
                                                            placeholder="تصویرپروفایل" accept="image/png, image/jpeg"
                                                            data-maxsize="5"
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea name="address" id="form-field-name"
                                                            class="elementor-field elementor-size-sm  elementor-field-textual"
                                                            placeholder="آدرس پستی" required="required"
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <span class="elementor-button-text">ویرایش
                                                                            اطلاعات</span>
                                                                    </span>
                                                                </button>
                                                            </div>
