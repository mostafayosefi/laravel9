...
<td> <a href="{{ route('user.nameserver.show', $admin) }}"> @include('index.layouts.table.getstatus', [$admin ,'route' => ''  ,'type_name' => 'status_domain'   ]) </a> </td>



        <td>
            @php $admin['title'] = $admin->domain;  @endphp
            @include('admin.layouts.table.modal', [$admin ,'route' => route('user.nameserver.destroy', $admin) , 'myname' => 'حذف سفارش تغییر نیم سرور '.$admin->domain ])
        </td>
